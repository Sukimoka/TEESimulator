 ...
 *
 * Tracks operation lifecycle: once [finish] or [abort] is called, subsequent calls will throw.
 * This matches AOSP keystore2 behavior where finalized operations return
